...
echo 'export PAGE_URL="https://output.circle-artifacts.com/output/job/${CIRCLE_WORKFLOW_JOB_ID}/artifacts/0/index.html"' >> "$BASH_ENV"
echo 'export QR_URL="https://output.circle-artifacts.com/output/job/${CIRCLE_WORKFLOW_JOB_ID}/artifacts/0/qrcode.png"' >> "$BASH_ENV"
